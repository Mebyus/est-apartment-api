...
func (m *MockEventRepo) Add(arg0 []model.ApartmentEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.ApartmentEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]model.ApartmentEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
